...
Developer.create!(first_name: "chloe", last_name: "Nguyen", rating: 2.8, skills: "17", prog_langage: "vuJS", work_zone: "Paris", project_done: 278, price_day: 965, owner_id: User.last.id)
Developer.create!(first_name: "Nathan", last_name: "Bertier", rating: 4.9, skills: "11", prog_langage: "C and C++", work_zone: "World", project_done: 1360, price_day: 42, owner_id: User.last.id)
